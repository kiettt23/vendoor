...
describe('ProductService', () => {
  ...
  describe('getProducts', () => {
    it('should return only products from active stores', async () => {
      const mockProducts = [
        { id: '1', name: 'Product 1', inStock: true, store: { isActive: true }, rating: [] },
        { id: '2', name: 'Product 2', inStock: true, store: { isActive: false }, rating: [] },
        { id: '3', name: 'Product 3', inStock: true, store: { isActive: true }, rating: [] },
      ];
  ...
  describe('getProductById', () => {
    ...
    it('should throw NotFoundError when product not found', async () => {
      ...
      await expect(productService.getProductById('invalid')).rejects.toThrow(NotFoundError);
    });
  });
