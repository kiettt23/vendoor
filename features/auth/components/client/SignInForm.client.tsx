...
import { authClient, signInSchema } from "@/features/auth/index.client";
...
export function SignInForm() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      const result = await authClient.signIn.username(validation.data);
    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            Sign in to your account. Don&apos;t have one?{" "}
