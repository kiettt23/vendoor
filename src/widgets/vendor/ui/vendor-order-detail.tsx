...
export async function VendorOrderDetailPage({ orderId }: VendorOrderDetailPageProps) {
  ...
  if (!order) {
    return (
      <div className="container mx-auto py-16 px-4 text-center">
        ...
        <Button asChild><Link href="/vendor/orders">Về danh sách đơn hàng</Link></Button>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      <Button variant="ghost" size="sm" asChild className="mb-6">
        <Link href="/vendor/orders"><ArrowLeft className="mr-2 h-4 w-4" />Danh sách đơn hàng</Link>
      </Button>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground">{order.customer.phone || order.shippingPhone}</p>
          </CardContent>
        </Card>
        <Card>
      ...
      <Card className="mb-8">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-green-600"><span>Thu nhập (sau phí nền tảng)</span><span>{formatPrice(order.vendorEarnings)}</span></div>
            <Separator />
