...
import {
  ...
  hasUserReviewed,
} from "@/entities/review/api/queries";
import { StarRating } from "@/entities/review";
import { isInWishlist } from "@/entities/wishlist/api/queries";
    ...
    <div className="container mx-auto py-8 lg:py-16 px-4">
      <Breadcrumb className="mb-6 lg:mb-8">
        <BreadcrumbList className="text-xs sm:text-sm">
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage className="truncate max-w-[120px] sm:max-w-[200px]">
              {product.name}
            </BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      ...
      {product.description && (
        <div className="mb-12 lg:mb-16">
          <h2 className="text-xl sm:text-2xl font-bold mb-4">Mô Tả</h2>
